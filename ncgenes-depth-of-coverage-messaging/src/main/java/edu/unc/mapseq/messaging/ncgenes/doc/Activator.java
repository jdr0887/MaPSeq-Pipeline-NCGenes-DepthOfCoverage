...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
        ...
        NCGenesDOCPipelineBeanService pipelineBeanService = null;
        ...
        if (references != null) {
            for (ServiceReference ref : references) {
                ...
                if (o instanceof NCGenesDOCPipelineBeanService) {
                    pipelineBeanService = (NCGenesDOCPipelineBeanService) o;
                    break;
                }
            }
        }
