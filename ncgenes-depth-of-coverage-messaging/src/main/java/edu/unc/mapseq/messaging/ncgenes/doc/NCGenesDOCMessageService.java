...
public class NCGenesDOCMessageService {
    ...
    private NCGenesDOCMessageListener messageListener;

    private String destinationName;

    public NCGenesDOCMessageService() {
        super();
    }
    ...
    public NCGenesDOCMessageListener getMessageListener() {
        return messageListener;
    }

    public void setMessageListener(NCGenesDOCMessageListener messageListener) {
